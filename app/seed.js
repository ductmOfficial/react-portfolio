...
export function seedDatabase() {
  ...
  addDoc(collection(db, 'jobs'), {
    ...
    node: {
      ...
      html:
        '<ul><li>Build modern web application, based on Javascript-style technologies</li><li>Developed and shipped highly interactive web applications for Comico</li><li>Clients included Korea, Japan, Thailand, Spain, Philippines and more</li><li>Participating in code reviews</li><li>Research new technology</li></ul>',
    },
  });
  ...
  //       company: '',
  //       cover:
  //         'https://d33wubrfki0l68.cloudfront.net/614bef10428d620008c9960b/screenshot_2021-09-23-03-06-26-0000.png',
  //     },
  //     html:
  //       '<p>ToDo App is simple and awesome app to organize your tasks with very easy to use interface. ToDo can help you to make list of your tasks. To-Do apps are not necessarily the hottest topic out there but this will really help you to sharpen you Svelte skills.</p>',
  //   },
  // });
  ...
  //       company: '',
  //       cover:
  //         'https://d33wubrfki0l68.cloudfront.net/6149eddf1a5a0f00070a9443/screenshot_2021-09-21-14-37-43-0000.png',
  //     },
  //     html:
  ...
  //       company: '',
  //       cover:
  //         'https://d33wubrfki0l68.cloudfront.net/614894d1660cd900083e4a7a/screenshot_2021-09-20-14-04-31-0000.png',
  //     },
  //     html:
  //       '<p>The program that we all use on a daily basis is the calculator. The calculator is a project that is both simple and practical. </p>',
  //   },
  // });
  ...
  //     },
  //     html:
  //       '<p>Online version of my 2021 resume made for fun. I was interested in learning React.js, so I found a simple tutorial and it spun into a weekend project.</p>',
  //   },
  // });
}
